...
def CASANonopC = Mobile.getText(findTestObject('Object Repository/M25SP3DGA-1039/06_VerifyG1ATransaction/34_NonOptionalReceive - JAMIL IBRAHIM BIN Y CASA_To_G1A'), 
    0)

////-----------------------------------------------------------Recepient Name-------------------------------------------------------------
CASANonopC0 = CASANonopC.replace(' *CASA_To_G1A', '')

def CASANonopC1 = CASANonopC0.contains('JAMIL IBRAHIM BIN Y')
...
CASANonopC2 = CASANonopC.replace('JAMIL IBRAHIM BIN Y *', '')
...
//------------------------------------------------------------* Seperator----------------------------------------------------------------
CASANonopC4 = CASANonopC.replace('JAMIL IBRAHIM BIN Y ', '')
...
def CASAOptC = Mobile.getText(findTestObject('Object Repository/M25SP3DGA-1039/06_VerifyG1ATransaction/35_OptionalReceive - CASA-G1A-Optional JAMIL IBRAHIM BIN Y CASA_To_G1A_Op'), 
    0)

////-----------------------------------------------------------Payment Details--------------------------------------------------------------
CASAOptC7 = CASAOptC.replace(' JAMIL IBRAHIM BIN Y *CASA_To_G1A_Op', '')
...
def CASAOptC11 = CASAOptC10.contains('JAMIL IBRAHIM BIN Y')
...
//-------------------------------------------------------------Receipient Reference------------------------------------------------------------
CASAOptC12 = CASAOptC.replace('CASA-G1A-Optional JAMIL IBRAHIM BIN Y *', '')
...
//------------------------------------------------------------* Seperator----------------------------------------------------------------
CASAOptC14 = CASAOptC.replace('CASA-G1A-Optional JAMIL IBRAHIM BIN Y ', '')
...
def CASAOptD = Mobile.getText(findTestObject('Object Repository/M25SP3DGA-1039/06_VerifyG1ATransaction/37.2_ G1A-CASA-Optional JAMIL IBRAHIM BIN Y G1A_To_CASA_Op'), 
    0)

////-----------------------------------------------------------Payment Details--------------------------------------------------------------
CASAOptD7 = CASAOptD.replace(' JAMIL IBRAHIM BIN Y *G1A_To_CASA_Op', '')
...
def CASAOptD11 = CASAOptD10.contains('JAMIL IBRAHIM BIN Y')
...
//-------------------------------------------------------------Receipient Reference------------------------------------------------------------
CASAOptD12 = CASAOptD.replace('G1A-CASA-Optional JAMIL IBRAHIM BIN Y *', '')
...
//------------------------------------------------------------* Seperator----------------------------------------------------------------
CASAOptD14 = CASAOptD.replace('G1A-CASA-Optional JAMIL IBRAHIM BIN Y ', '')
