...
def CASANonOpD = Mobile.getText(findTestObject('Object Repository/M25SP3DGA-1039/07_VerifyCASATransaction/46_CASA_NonOptionalAccDebit - JAMIL IBRAHIM BIN YCASA_To_G1A'), 
    0)
...
def CASAOpD = Mobile.getText(findTestObject('Object Repository/M25SP3DGA-1039/07_VerifyCASATransaction/47_CASA_OptionalAccDebit - CASA-G1A-Optional JAMIL IBRAHIM BIN YCASA_To_G1A_Op'), 
    0)
...
def CASANonOpC = Mobile.getText(findTestObject('Object Repository/M25SP3DGA-1039/07_VerifyCASATransaction/48_CASA_NonOptionalCredit - JAMIL IBRAHIM BIN YG1A_To_CASA'), 
    0)
...
def CASAOpC = Mobile.getText(findTestObject('Object Repository/M25SP3DGA-1039/07_VerifyCASATransaction/49_CASA_OptionalCredit - G1A-CASA-Optional JAMIL IBRAHIM BIN YG1A_To_CASA_Op'), 
    0)
